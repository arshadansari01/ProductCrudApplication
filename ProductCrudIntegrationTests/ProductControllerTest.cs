...
//        {
//            var updatedProduct = new Product { Name = "Updated Product", Price = 149, CategoryId = 1, Description="Ultron" , ProductId =1};
          
//            var updatedResponse = await _client.PutAsJsonAsync("/api/product", updatedProduct);
...
//        {
//            var response = await _client.DeleteAsync("/api/product/12");
//            response.EnsureSuccessStatusCode();
